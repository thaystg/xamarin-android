...
namespace xamarin { namespace android { namespace internal
{
	...
	class AndroidSystem
	{
		// These values are completely arbitrary, but they should be quite enough for your
		// purposes without being too limiting
		static constexpr unsigned long MAX_ENVVAR_NAME_WIDTH = 512;
		static constexpr unsigned long MAX_ENVVAR_VALUE_WIDTH = 1024;
	private:
#if defined (DEBUG) || !defined (ANDROID)
